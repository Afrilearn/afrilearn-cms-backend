...
//         };
//       });
//       it('should not create question if questions Array is empty', (done) => {
//         dynamicQuestion.questionsArray = '';
//         request.send(dynamicQuestion).end((err, res) => {
//           res.should.have.status(400);
//           res.body.should.have.property('status').to.equals('error');
//           res.body.should.have
//             .property('errors')
//             .to.include('Questions Array cannot be empty');
//           done();
//         });
//       });
...
//       const createdLesson = await Lesson.create(lesson);
//       lessonId = createdLesson._id;
//       const createdQuiz = await Question.create({
